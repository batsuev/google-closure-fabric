...
class CustomServer(TCPServer):
    def __init__(self, project_path, server_address, RequestHandlerClass, deps_builder=None, html_folder='.'):
...
def serve(project_path, port=8000, html_folder='.', deps_builder=None, stylesheets_builder=None, templates_builder=None,
          js_builder=None):
    httpd = CustomServer(project_path, ("", port), RequestHandler, deps_builder, html_folder)
